...
function Card({
  ...
  return (
    <>
      ...
      <motion.section className={`${isDarkMode ? "bg-slate-800" : "bg-white"}`}>
        <motion.div className={`flex justify-between p-5 sm:py-4`}>
          <motion.div id="user-info" className={`flex items-center space-x-4`}>
            ...
            {signalVisibility && (
              <SocialTags instagramTag={instagramTag} twitterTag={twitterTag} />
            )}
          </motion.div>

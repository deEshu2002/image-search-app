        ...
        <div className="relative h-fit">
          ...
          >
            ...
            <div className="relative ">
              <img
                className={`${
                  mode ? "bg-slate-400" : "bg-white "
                } relative bg-gray-100 rounded-t-lg w-full max-h-[50rem] object-contain object-center`}
                src={`${props.imageLink}`}
                alt={``}
              />
                ...
                <div className="flex justify-between">
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1 min-w-0 text-left align-text-top">
                      <p
                        ...
                        } leading-tight text-base font-bold  truncate dark:text-white`}
                      >
                        {`${props.user}`}
                      </p>
                      <p
                        className={` ${
                          mode ? "text-slate-100" : "text-gray-900"
                        } leading-tight text-sm italic text-gray-500 truncate dark:text-gray-400`}
                      >
                        {`@${props.userName}`}
                      </p>
                    </div>
                      ...
                      <a
                        className={`${
                          mode
                            ...
                            : "text-gray-900 hover:text-slate-800"
                        } flex italic items-center  text-gray-500   cursor-pointer`}
                      >
                        <svg
                          width="20px"
                          height="20px"
                  ...
                  <div className="flex gap-6 mb-1.5">
                    <div
                      ...
                      } inline-flex gap-2 items-end text-sm text-gray-900 dark:text-white cursor-pointer`}
                    >
                      <p className="font-bold text-base ">
                        {`${HandleDigits(props.downloads)}`}
                      </p>
                      <p className={` font-bold text-base`}>downloads</p>
                    </div>
                    <div
                      className={`${
                        mode
                          ? "text-slate-300 hover:text-slate-100"
                          : "text-gray-600 hover:text-slate-900"
                      }  inline-flex gap-1 items-end text-sm cursor-pointer text-gray-900 dark:text-white`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
